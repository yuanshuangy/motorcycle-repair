...
const fetchData = async () => { try { const r=await appointmentAPI.getPage({pageNum:pageNum.value,pageSize:pageSize.value}); if(r.code===200) { list.value=r.data.records; total.value=r.data.total } } catch{} }
